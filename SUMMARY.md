...
* [Generative Requests](fluent-api-requests/generative-requests/README.md)
  * [Text](fluent-api-requests/generative-requests/text.md)
  * [Image](fluent-api-requests/generative-requests/image.md)
  * [Video](fluent-api-requests/generative-requests/video.md)
  * [Speech](fluent-api-requests/generative-requests/speech.md)
  * [Transcript](fluent-api-requests/generative-requests/transcript.md)
  * [SoundFX](fluent-api-requests/generative-requests/soundfx.md)
  * [Voice Change](fluent-api-requests/generative-requests/voice-change.md)
  * [Audio Isolation](fluent-api-requests/generative-requests/audio-isolation.md)
  * [Embedding](fluent-api-requests/generative-requests/embedding.md)
  * [Moderation](fluent-api-requests/generative-requests/moderation.md)
* [Provider API Requests](fluent-api-requests/provider-api-requests/README.md)
  * [File Requests](fluent-api-requests/provider-api-requests/file-requests/README.md)
    * [Upload File](fluent-api-requests/provider-api-requests/file-requests/upload-file.md)
    * [Download File](fluent-api-requests/provider-api-requests/file-requests/download-file.md)
    * [Delete File](fluent-api-requests/provider-api-requests/file-requests/delete-file.md)
    * [List Files](fluent-api-requests/provider-api-requests/file-requests/list-files.md)
  * [Model Requests](fluent-api-requests/provider-api-requests/model-requests/README.md)
    * [Get Model](fluent-api-requests/provider-api-requests/model-requests/get-model.md)
    * [List Models](fluent-api-requests/provider-api-requests/model-requests/list-models.md)
    * [Get Custom Model](fluent-api-requests/provider-api-requests/model-requests/get-custom-model.md)
    * [List Custom Models](fluent-api-requests/provider-api-requests/model-requests/list-custom-models.md)
    * [Delete Custom Model](fluent-api-requests/provider-api-requests/model-requests/delete-model.md)
  * [Voice Requests](fluent-api-requests/provider-api-requests/voice-requests/README.md)
    * [List Voices](fluent-api-requests/provider-api-requests/voice-requests/list-voices.md)
    * [List Custom Voices](fluent-api-requests/provider-api-requests/voice-requests/list-custom-voices.md)
...
* [Essentials](ai-agents/essentials/README.md)
  * [Agent Configuration](ai-agents/essentials/configuration/README.md)
    * [Agent Settings](ai-agents/essentials/configuration/agent-settings.md)
    * [Chat Service API Types](ai-agents/essentials/configuration/chat-service-types.md)
    * [Conversation Store](ai-agents/essentials/configuration/conversation-store.md)
    * [Audio Setup](ai-agents/essentials/configuration/audio-setup.md)
    * [Memory Settings](ai-agents/essentials/configuration/memory-settings.md)
  * [Agent Lifecycle](ai-agents/essentials/lifecycle/README.md)
    * [Initialization](ai-agents/essentials/lifecycle/initialization.md)
    * [Agent Status](ai-agents/essentials/lifecycle/agent-status.md)
    * [Disposal](ai-agents/essentials/lifecycle/disposal.md)
  * [Conversation Management](ai-agents/essentials/conversation/README.md)
    * [Creating Conversations](ai-agents/essentials/conversation/creating-conversations.md)
    * [Loading & Saving](ai-agents/essentials/conversation/loading-and-saving.md)
    * [Messages & Items](ai-agents/essentials/conversation/messages-and-items.md)
    * [Context Assembly](ai-agents/essentials/conversation/context-assembly.md)
  * [Generating Responses](ai-agents/essentials/responses/README.md)
    * [Text Messages](ai-agents/essentials/responses/text-messages.md)
    * [Streaming vs Non-Streaming](ai-agents/essentials/responses/streaming.md)
    * [File Attachments](ai-agents/essentials/responses/file-attachments.md)
    * [Audio Input](ai-agents/essentials/responses/audio-input.md)
    * [Canceling Requests](ai-agents/essentials/responses/canceling.md)
  * [Parameters](ai-agents/essentials/parameters/README.md)
    * [Models](ai-agents/essentials/parameters/models.md)
    * [Voice](ai-agents/essentials/parameters/voice.md)
    * [Tools & Tool Choice](ai-agents/essentials/parameters/tools.md)
    * [Temperature & Max Tokens](ai-agents/essentials/parameters/temperature-tokens.md)
    * [Preferences Store](ai-agents/essentials/parameters/preferences-store.md)
  * [Audio](ai-agents/essentials/audio/README.md)
    * [Input Audio Recorder](ai-agents/essentials/audio/input-recorder.md)
    * [Output Audio Player](ai-agents/essentials/audio/output-player.md)
    * [Transcription](ai-agents/essentials/audio/transcription.md)
    * [Text-to-Speech](ai-agents/essentials/audio/text-to-speech.md)
  * [Events & Hooks](ai-agents/essentials/events/README.md)
    * [Agent Hooks](ai-agents/essentials/events/agent-hooks.md)
    * [Text Delta Events](ai-agents/essentials/events/text-delta.md)
    * [Tool Call Events](ai-agents/essentials/events/tool-calls.md)
    * [Audio Events](ai-agents/essentials/events/audio.md)
    * [Status Events](ai-agents/essentials/events/status.md)
    * [Error Handling](ai-agents/essentials/events/error-handling.md)
  * [Advanced Topics](ai-agents/essentials/advanced/README.md)
    * [Agent Services](ai-agents/essentials/advanced/agent-services.md)
    * [Controllers Architecture](ai-agents/essentials/advanced/controllers.md)
    * [Event Router](ai-agents/essentials/advanced/event-router.md)
    * [Custom Chat Services](ai-agents/essentials/advanced/custom-chat-services.md)
* [Tools](ai-agents/tools/README.md)
  ...
  * [MCP Integration](ai-agents/tools/mcp/README.md)
    * [OAuth Token Providers](ai-agents/tools/mcp/oauth-providers.md)
    * [Approval Handlers](ai-agents/tools/mcp/approval-handlers.md)
    * [Approval Timeout](ai-agents/tools/mcp/approval-timeout.md)
    * [Access Token Service](ai-agents/tools/mcp/access-token-service.md)
