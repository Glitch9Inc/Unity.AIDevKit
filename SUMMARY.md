...
* [Overview](agent/overview/README.md)
* [Tools](agent/tools/README.md)
  * [Tool Calls](agent/tools/tool-calls/README.md)
    * [Function](agent/tools/tool-calls/function.md)
    * [Local Shell](agent/tools/tool-calls/local-shell.md)
    * [Computer Use](agent/tools/tool-calls/computer-use.md)
  * [Hosted Tools](agent/tools/hosted-tools/README.md)
    * [File Search](agent/tools/hosted-tools/file-search.md)
    * [Code Interpreter](agent/tools/hosted-tools/code-interpreter.md)
    * [Web Search](agent/tools/hosted-tools/web-search.md)
    * [MCP Tool](agent/tools/hosted-tools/mcp.md)
    * [Image Generation](agent/tools/hosted-tools/image-generation.md)
  * [Local Tools](agent/tools/local-tools/README.md)
    * [Image Generation](agent/tools/local-tools/image-generation.md)
    * [Speech Generation](agent/tools/local-tools/speech-generation.md)
    * [Speech Transcription](agent/tools/local-tools/speech-transcription.md)
  * [Google Tools](agent/tools/google-tools/README.md)
    * [Google Search](agent/tools/google-tools/google-search.md)
    * [URL Context](agent/tools/google-tools/url-context.md)
    * [Code Execution](agent/tools/google-tools/code-execution.md)
